...
# python3 train_vgg.py --dataset dataset/train --model output/smallvggnet.model --label-bin output/smallvggnet_lb.pickle --plot output/smallvggnet_plot.png
...
def main():
	...
	model = VGGNet.build(width=WIDTH, height=HEIGHT, depth=3, classes=len(lb.classes_))
